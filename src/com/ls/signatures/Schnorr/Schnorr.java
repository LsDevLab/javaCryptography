...
public class Schnorr {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Setup
        SchnorrSK SK = Setup(512);
        System.out.println("secretKey = " + SK.getS());
        System.out.println("p = " + SK.getPK().p);
        System.out.println("q = " + SK.getPK().q);
        // Sign
        String M = "Ciao";
        ...
        // Verify
        System.out.println("Verification = " + Verify(sigma, SK.getPK(), M));
    }
